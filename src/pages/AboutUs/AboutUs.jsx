    ...
    <>
      ...
      >
        <Container className="text-center transicion-pagina py-4">
          ...
          <h1 className="font-serif display-4 mb-4 text-light fw-bold">
            Nació de noche, <em className="text-accent-primary">como todo lo bueno</em>
          </h1>
          <p className="text-text-secondary fs-5 mx-auto mb-0" style={{ maxWidth: "700px", lineHeight: "1.6" }}>
        ...
        <Container className="transicion-pagina-horizontal py-3">
          <Row className="gy-4 align-items-center">
            <Col xs={12} md={6}>
              ...
              <h2 className="font-serif h2 text-light mb-0" style={{ lineHeight: "1.3" }}>
                Empezó con una pila de libros y muchas ganas
              </h2>
            </Col>
            <Col xs={12} md={6}>
              <p className="text-text-secondary mb-3" style={{ fontSize: "0.95rem", lineHeight: "1.6" }}>
              ...
              <p className="text-text-secondary mb-0" style={{ fontSize: "0.95rem", lineHeight: "1.6" }}>
      ...
      >
        <Container className="py-3">
          ...
          <Row className="g-4">
            {valores.map((valor) => (
              <Col key={valor.titulo} xs={12} md={4} className="text-center px-4">
                <h3 className="font-serif h4 text-accent-primary mb-3">
                  {valor.titulo}
                </h3>
                <p className="text-text-secondary mb-0" style={{ fontSize: "0.9rem", lineHeight: "1.6" }}>
                  {valor.texto}
                </p>
              </Col>
            ))}
