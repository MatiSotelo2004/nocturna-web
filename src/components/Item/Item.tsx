...
export default function Item(producto: Product) {
  ...
  return (
    <div
      className={`${styles.bookCard} ${isOutOfStock ? styles.outOfStockCard : ""}`}
    >
      {/* PORTADA */}
      <Link
      ...
      >
        ...
        >
          <img
            ...
            style={
              isOutOfStock ? { filter: "grayscale(1) brightness(0.4)" } : {}
            }
          />
          {isOutOfStock ? (
            <div
      ...
      <div className="card-body d-flex flex-column p-3 justify-content-between flex-grow-1">
        <div>
          ...
          <p className="text-text-secondary small mb-3">{producto.autor}</p>
        </div>
        ...
        <div className="mt-auto">
          ...
          <button
            ...
            style={
              isOutOfStock
                ? {
                    backgroundColor: "rgba(155, 151, 168, 0.2)",
