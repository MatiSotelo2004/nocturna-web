...
import TeamCard from "@/components/Layout/Footer/TeamCard";
      ...
      <Container>
        ...
        <Row className="gy-4 align-items-center mb-4">
          <Col xs={12} md={6}>
            ...
            <p
              className="mb-0 text-text-secondary"
          ...
          <Col
            xs={12}
            md={6}
            className="d-flex flex-column gap-2 text-md-end text-start"
          >
        ...
        <Row className="align-items-center gy-2">
          <Col
            xs={12}
            sm={6}
            className="text-center text-sm-start text-text-secondary text-sm"
          >
          ...
          <Col
            xs={12}
            sm={6}
            className="text-center text-sm-end text-accent-primary font-serif tracking-widest"
          >
            NOCTURNA
          </Col>
        </Row>
